...
void InitColors(void)
{
    ...
    DefineColor("Orange", 1, .502, .1);
    DefineColor("Yellow", 1, 1, 0);
    DefineColor("Green", 0.22, 0.37, 0.06);
    DefineColor("Blue", 0, 0, 1);
    DefineColor("Violet", .93, .5, .93);
    DefineColor("Magenta", 1, 0, 1);
    DefineColor("Cyan", 0, 1, 1);

    DefineColor("Ivory Black", 0.16, 0.14, 0.13);
    DefineColor("Cobalt Green", 0.24, 0.57, 0.25);
    DefineColor("Wood", 0.545, 0.27, 0.0745);
    DefineColor("Golden", 1, 0.843, 0);
    DefineColor("Almond", 1, 0.92, 0.80);
    DefineColor("Leather", 0.369, 0.149, 0.071);
    DefineColor("Floor", 0.447, 0.325, 0.204);
    DefineColor("Indian Red", .690, .090, .122);
    DefineColor("Dodger Blue", .118, .565, 1);
    DefineColor("Black Green", 0, 0.341, 0.216);
    DefineColor("Dark Ochre", 0.588, 0.294, 0);
    DefineColor("Cold Gray", .502, .541, .529);
}
